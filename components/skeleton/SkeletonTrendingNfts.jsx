    ...
    return (
        <>
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-4 grid-cols-1  p-1">
                <div className="border border-blue-300 dark:bg-[#16151a]  dark:border-[#16151a] shadow rounded-md p-2 w-full ">
                    <div className="animate-pulse ">
                        <div className="h-72  w-100 bg-slate-200  dark:bg-[#48474c]  rounded-lg"></div>

                        <div className="bg-slate-200  dark:bg-[#48474c]  w-32 h-2 mt-5 mb-4 rounded"> </div>
                        <div className="bg-slate-200  dark:bg-[#48474c]  w-20 h-2 rounded"> </div>
